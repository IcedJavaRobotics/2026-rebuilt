...
public class FullShootOverrideCommand extends Command {
  ShooterSubsystem shooterSubsystem;
  SpindexerSubsystem spindexerSubsystem;
  LimelightSubsystem limelightSubsystem;
  /** Creates a new FullShootCommand. */
  public FullShootOverrideCommand(  ShooterSubsystem shooterSubsystem,SpindexerSubsystem spindexerSubsystem,LimelightSubsystem limelightSubsystem) {
