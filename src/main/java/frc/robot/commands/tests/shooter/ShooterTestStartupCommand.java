...
public class ShooterTestStartupCommand extends Command {

  ShooterSubsystem shooterSubsystem;

  /** Creates a new ShooterTestStartupCommand. */
  public ShooterTestStartupCommand(ShooterSubsystem shooterSubsystem) {
